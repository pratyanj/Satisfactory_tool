...
const REGISTRY: MachineRegistryEntry[] = [
  ...
  // ── Logistics ──────────────────────────────────────────────────────────────
  // All splitters: 1 input on the LEFT, 3 outputs on TOP / RIGHT / BOTTOM.
  // All mergers:   3 inputs on TOP / LEFT / BOTTOM, 1 output on the RIGHT.
  // This mirrors Satisfactory's in-game 4-way port layout in a top-down 2-D view.
  {
    machineId: 'conveyor_splitter',
    footprint: { width: 1, height: 1 },
    ports: [
      { id: 'in0',  type: 'input',  medium: 'belt', relX: 0.0, relY: 0.5 }, // left  — input
      { id: 'out0', type: 'output', medium: 'belt', relX: 0.5, relY: 0.0 }, // top   — output
      { id: 'out1', type: 'output', medium: 'belt', relX: 1.0, relY: 0.5 }, // right — output
      { id: 'out2', type: 'output', medium: 'belt', relX: 0.5, relY: 1.0 }, // bottom— output
    ],
    category: 'logistics',
    accentColor: '#f59e0b',
    order: 1,
  },
  {
    ...
    footprint: { width: 1, height: 1 },
    ports: [
      { id: 'in0',  type: 'input',  medium: 'belt', relX: 0.5, relY: 0.0 }, // top   — input
      { id: 'in1',  type: 'input',  medium: 'belt', relX: 0.0, relY: 0.5 }, // left  — input
      { id: 'in2',  type: 'input',  medium: 'belt', relX: 0.5, relY: 1.0 }, // bottom— input
      { id: 'out0', type: 'output', medium: 'belt', relX: 1.0, relY: 0.5 }, // right — output
    ],
    category: 'logistics',
    accentColor: '#3b82f6',
    order: 2,
