...
export function LogisticsNode({ id, data }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <img src={`https://wsrv.nl/?url=${encodeURIComponent(imgUrl)}&w=64&output=webp&maxage=30d`} crossOrigin="anonymous" alt={data.type as string} className="w-full h-full object-contain drop-shadow-md" />
