      ...
      <div className="sf-header-container">
        ...
        <div className="sf-header-nav-cutout">
          <div className="sf-nav-links">
            ...
            <button
              onClick={() => handleTopLevelTab('sandbox')}
              className={`sf-nav-btn ${topLevelTab === 'sandbox' ? 'active' : ''}`}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M3 9h18M9 21V9" /></svg>
              Sandbox
            </button>
            <button
